...
namespace Nat23
{
    ...
    // Core Functions
        ...
        void showHelpRolls()
        {
            ...
            help_txt += "If present, the total will only take the best n values out of the total rolls specified in the basic roll (must be less than the number of dice).\n";
        ...
        void parseRoll(std::string rollstring)
        {
            ...
            try
            {
                ...
                if (getSplit(rollstring, "+", 0, "NA") != "NA")
                {
                    ...
                    if (advantage > safety_limit)
                    {
                        advantage = safety_limit;
                    }
                ...
                if (getSplit(rollstring, "-", 0, "NA") != "NA")
                {
                    ...
                    if (penalty > safety_limit)
                    {
                        penalty = safety_limit;
                    }
                    rollstring = getSplit(rollstring, "-", 0, rollstring);
                }
